...
| **Final accepted rows** | **64 / 100** |
| Needs human review | 32 / 100 |
| Rejected | 4 / 100 |
...
medqa_ragas_golden.jsonl                 # FINAL — accepted golden samples ←
medqa_ragas_golden_needs_review.jsonl    # awaiting manual review
```
